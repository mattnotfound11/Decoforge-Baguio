...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-ink text-white">
      ...
      <div
        className="absolute -left-40 top-0 h-[520px] w-[520px] rounded-full bg-rust/20 blur-[140px]"
        aria-hidden="true"
      />
      ...
      <div className="container-df relative grid items-center gap-12 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:py-24">
        <div>
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <Link
              href="/catalog"
              className="inline-flex items-center justify-center rounded-lg bg-rust px-7 py-4 text-[15px] font-bold transition hover:bg-rust-2"
            >
              Browse Materials
            </Link>
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-lg border border-white/25 px-7 py-4 text-[15px] font-bold transition hover:border-white hover:bg-white hover:text-ink"
            >
              Book Now
            </Link>
          </div>
